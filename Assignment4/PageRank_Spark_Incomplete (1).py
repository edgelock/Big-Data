...
AdjList1 = sc.textFile("/home/jcharles/data/02AdjacencyList.txt")
...
for i in range(1, 30):
    ...
    contributions = JoinRDD.flatMap(lambda x_y_z : [(i, x_y_z[1][1] / len(x_y_z[1][0])) for i in x_y_z[1][0]])
    print("contributions")
...
#PageRankValues.coalesce(1).saveAsTextFile("/home/jcharles/data/PageRankValues_Final")